...
function All_darzi() {
    ...
    useEffect(() => {
        create_all_darzi_cards();
    }, []);



    const create_all_darzi_cards = () => {

        for (let i = 0; i < 0; i++) {

            const show_all_darzi_cards = document.getElementById('show_all_darzi_cards')
            ...
            show_all_darzi_cards.appendChild(all_user_card_main_div)
            ...
            <section className="home-section">
                ...
                <div className="home-header">
                    <div className="home-header-inner-div">
                        ...
                        <span className="text"> ALL DARZI </span>
                    </div>
                </div>

                <div className="main_home_section">
                    <div className="inner_home_section" style={{ boxShadow: "0px 0px 0px 0px" }}>
                        <div className="main_all_users_card_div" id="show_all_darzi_cards">
