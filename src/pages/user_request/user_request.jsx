...
function User_request() {
    ...
    useEffect(() => {
        create_all_user_request_cards();
    }, []);

    const create_all_user_request_cards = () => {


        for (let i = 0; i < 0; i++) {

            const show_all_users_request_cards = document.getElementById('show_all_users_request_cards');
            ...
            show_all_users_request_cards.appendChild(wrapper);
            ...
            <section className="home-section">
                ...
                <div className="main_home_section">
                    <div className="inner_home_section" style={{ boxShadow: "0px 0px 0px 0px" }}>
                        ...
                        <div className="all_users_card_holder" id="show_all_users_request_cards">
